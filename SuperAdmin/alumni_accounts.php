<?php
  ...
  if(!isset($_SESSION['sess_id'])){
    ...
    if(isset($_GET['id'])){
        $alumni_id = $_GET['id'];
        $delete_alumni = mysqli_query($conn, "DELETE FROM `users` WHERE id ='$alumni_id' AND user_type = '5'");
    
        if($delete_alumni == true){
            ?> 
            <script>
...
<body>
    ...
    <div class="alumni-accounts" style="width:70%"><br>
        <div class="container pt-5" style="margin-left: 320px"><br>
            <h2>Alumni Accounts</h2><br>
                        ...
                        <table id="example" class="table table-hover border-primary text-center">
                            ...
                            while ($row = mysqli_fetch_array($data)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="alumni_profile.php?id=<?php echo $row['id']; ?>" title = "View Profile"><i class="bi bi-person-lines-fill" style="color: black; padding: 5px"></i></i></a>
                                        <a href="edit_alumni.php?id=<?php echo $row['id']; ?>" class="mr-3 edituser" title="Edit" data-target="usermodal" data-toggle="modal"><i class="bi bi-pencil-square" style="color: blue; padding: 3px"></i></a>
                                        <a href="alumni_accounts.php?id=<?php echo $row['id']; ?>" title="Delete"><i class="bi bi-trash" style="color: red; padding: 3px"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                    </tbody>
