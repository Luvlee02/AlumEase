                  ...
                  <form action="../process.php?id=<?php echo $browserId;?>" method="POST">
                    <div class="row" style="padding-top: 50px;">
                        <div class="col-xl-8" style="margin-left: 300px;">
                            <div class="card mb-8">
                            <div class="card-header text-white bg-success"><h3>Edit User Account Details</h3></div>
                    ...
                    <div class="card-body">                        
                        ...
                        <button type="submit" class="btn btn-success" name="alumni">Save Changes</button>
