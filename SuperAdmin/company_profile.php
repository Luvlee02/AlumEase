      ...
      <div class="container mt-3" style="padding-left: 200px;">
        <div class="card" style="width:800px">
          <div class="card-body">
            ...
            <input type= "text" class="form-control" name="update_fname" value="<?php echo $fname3; ?>" disabled><br>
            
            <div class="row gx-3 mb-3">
              <div class="col-md-6">
                <label><b>In Charge</b></label>
                <input type= "text" class="form-control" name="update_lname" value="<?php echo $lname3; ?>" disabled>
            </div>

            <div class="col-md-6">
                <label><b>Position</b></label>
                <input type= "text" class="form-control" name="update_gender" value="<?php echo $gender3; ?>" disabled>
                </div>
            </div>
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-6">
                ...
                <input type= "email" class="form-control" name="update_email" value="<?php echo $email3; ?>" disabled>
              </div>
              
              <div class="col-md-6">
                <label><b>Password</b></label>
                <input type= "password" class="form-control" name="update_password" value="<?php echo $password3; ?>" disabled>
                </div>
            </div>
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-6">
                ...
                <input type= "text" class="form-control" name="update_bday" value="<?php echo $bday3; ?>" disabled>
              </div>

              <div class="col-md-6">
                <label><b>Industry</b></label>
                <input type= "text" class="form-control" name="update_yr_graduated" value="<?php echo $yr_graduated3; ?>" disabled>
                </div>
            </div>
            ...
            <div class="row gx-3 mb-3">
              <div class="col-md-6">
                ...
                <input type= "text" class="form-control" name="update_cnum" value="<?php echo $cnum3; ?>" disabled>
              </div> 

              <div class="col-md-6">
                <label><b>Website Link</b></label>
                <input type= "text" class="form-control" name="update_course" value="<?php echo $course3; ?>" disabled>
                </div>
            </div>

             <label><b>Address</b></label>
            <input type= "text" class="form-control" name="update_address" value="<?php echo $address3; ?>"disabled><br>
