...
<input type="checkbox" id="check"> 
   ...
   <header>
    ...
    <div class="alumni" style="width:70%;">
          ...
          <table id="example" class="table table-hover border-primary text-center">
            <thead class="table-success">
              ...
              <?php         
                ...
                JOIN user_profile p
                ON u.id = p.id 
                WHERE u.user_type = '5' AND u.user_status = '1'";
              ...
              ?>
                  ...
                  <tr>
                    ...
                    <td><a href="edit_alumni.php?id=<?php echo $row['id'];?>" class="mr-3 edituser" title="Edit" data-target="usermodal" 
                      data-toggle="modal"><i class="bi bi-pencil-square" style="font-size: 20px; color: black;"></i></a>
                    <a href="../delete.php?id=<?php echo $row['id'];?>"><i class="bi bi-trash" 
                    style="font-size: 20px; color: red; padding: 5px" title="Delete"></i></a></td>
